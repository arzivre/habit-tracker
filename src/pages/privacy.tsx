...
const Privacy = () => {
  return (
    <>
      <Head>
        <title>Habit Tracker - Privacy</title>
        <meta
          name="description"
      ...
      <main className="mx-auto max-w-[80ch] px-4 pt-10">
        ...
        <p>
          At Improve Everyday, accessible from
          https://improve-everyday.vercel.app, one of our main priorities is the
          privacy of our visitors. This Privacy Policy document contains types
          of information that is collected and recorded by Improve Everyday and
          how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in Improve Everyday. This policy is not
        ...
        <p>
          Improve Everyday follows a standard procedure of using log files.
        ...
        <p>
          Like any other website, Improve Everyday uses &apos;cookies&apos;.
        ...
        <p>
          ...
          advertising partners of Improve Everyday.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Improve Everyday, which are
        ...
        <p>
          Note that Improve Everyday has no access to or control over these
        ...
        <p>
          Improve Everyday&apos;s Privacy Policy does not apply to other
        ...
        <p>
          Improve Everyday does not knowingly collect any Personal Identifiable
